...
class ActionObservable {
  static actionObservable (message) {
    return Rx.Observable.create(async (observer) => {
      try {
        const payload = message.value.content.payload
        const action = payload.messageDetails.action
        const actionFunc = ActionObservable.actionBuilder(action)
